...
class OneTwoNumberFragment : Fragment() {

   private val random1 =  listOf(4,5,6,7,8,9,10).shuffled()
    private val random2 =  listOf(4,5,6,7,8,9,10).shuffled()

    val questions = listOf(
        Question("${random1[0]} - ${random1[0]-1} =", 1),
        Question("${random1[1]} - ${random1[1]-1} =", 1),
        Question("${random2[0]} - ${random2[0]-2} =", 2),
        Question("${random2[1]} - ${random2[1]-2} =",2),
        Question("${random1[2]} - ${random1[2]-1} =", 1),
        Question("${random2[2]} - ${random2[2]-2} =", 2),
        Question("${random1[3]} - ${random1[3]-1} =", 1),
        Question("${random2[3]} - ${random2[3]-2} =", 2),
        Question("${random1[4]} - ${random1[4]-1} =", 1),
        Question("${random2[4]} - ${random2[4]-2} =", 2),
        Question("${random1[5]} - ${random1[5]-1} =", 1),
        Question("${random2[5]} - ${random2[5]-2} =", 2),
        Question("${random1[6]} - ${random1[6]-1} =", 1),
        Question("${random2[6]} - ${random2[6]-2} =", 2),
        Question(" ", 0)
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_one_two_number, container, false)
        ...
        image11 = view.findViewById(R.id.aplle11) as ImageView
        image12 = view.findViewById(R.id.aplle12) as ImageView
        image13 = view.findViewById(R.id.aplle13) as ImageView
