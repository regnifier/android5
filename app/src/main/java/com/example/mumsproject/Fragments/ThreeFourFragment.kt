...
class ThreeFourFragment : Fragment() {

    private val random1 =  listOf(4,5,6,7,8,9,10).shuffled()
    private val random2 =  listOf(4,5,6,7,8,9,10).shuffled()

    val questions = listOf(
        Question("${random1[0]} - ${random1[0]-3} =", 3),
        Question("${random1[1]} - ${random1[1]-3} =", 3),
        Question("${random2[0]} - ${random2[0]-4} =", 4),
        Question("${random2[1]} - ${random2[1]-4} =",4),
        Question("${random1[2]} - ${random1[2]-3} =", 3),
        Question("${random2[2]} - ${random2[2]-4} =", 4),
        Question("${random1[3]} - ${random1[3]-3} =", 3),
        Question("${random2[3]} - ${random2[3]-4} =", 4),
        Question("${random1[4]} - ${random1[4]-3} =", 3),
        Question("${random2[4]} - ${random2[4]-4} =", 4),
        Question("${random1[5]} - ${random1[5]-3} =", 3),
        Question("${random2[5]} - ${random2[5]-4} =", 4),
        Question("${random1[6]} - ${random1[6]-3} =", 3),
        Question("${random2[6]} - ${random2[6]-4} =", 4),
        Question(" ", 0)
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_three_four, container, false)
