...
class minusOneFragment : Fragment() {
    ...
    val questions = listOf(
        Question("${random[0]} - 1 =", random[0]-1),
        Question("${random[1]} - 1 =", random[1]-1),
        Question("${random[2]} - 1 =", random[2]-1),
        Question("${random[3]} - 1 =", random[3]-1),
        Question("${random[4]} - 1 =", random[4]-1),
        Question("${random[5]} - 1 =", random[5]-1),
        Question("${random[6]} - 1 =", random[6]-1),
        Question("${random[7]} - 1 =", random[7]-1),
        Question("${random[8]} - 1 =", random[8]-1),
        Question("${random[9]} - 1 =", random[9]-1),
        Question(" ", 1)
    )
