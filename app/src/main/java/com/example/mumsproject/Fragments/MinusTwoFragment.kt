...
class MinusTwoFragment : Fragment() {

    private val random =  listOf(2,3,4,5,6,7,8,9,10).shuffled()


    val questions = listOf(
        Question("${random[0]} - 2 =", random[0]-2),
        Question("${random[1]} - 2 =", random[1]-2),
        Question("${random[2]} - 2 =", random[2]-2),
        Question("${random[3]} - 2 =", random[3]-2),
        Question("${random[4]} - 2 =", random[4]-2),
        Question("${random[5]} - 2 =", random[5]-2),
        Question("${random[6]} - 2 =", random[6]-2),
        Question("${random[7]} - 2 =", random[7]-2),
        Question("${random[8]} - 2 =", random[8]-2),
        Question(" ", 2)
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_minus_two, container, false)
