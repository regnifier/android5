...
class PlusThreeFragment : Fragment() {

    private val random =  listOf(0,1, 2,3,4,5,6,7).shuffled()


    val questions = listOf(
        Question("${random[0]} + 3 =", random[0]+3),
        Question("${random[1]} + 3 =", random[1]+3),
        Question("3 + ${random[2]} =", random[2]+3),
        Question("${random[3]} + 3 =", random[3]+3),
        Question("3 + ${random[4]} =", random[4]+3),
        Question("${random[5]} + 3 =", random[5]+3),
        Question("3 + ${random[6]} =", random[6]+3),
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_plus_three, container, false)
