...
class OneTwoThreeFourFragment : Fragment() {
    ...
    val questions = listOf(
        ...
        Question("${random1[2]} - ${random1[2]-4} =", 4),
        Question("${random2[2]} - ${random2[2]-2} =", 2),
        Question("${random1[3]} - ${random1[3]-3} =", 3),
        Question("${random2[3]} - ${random2[3]-1} =", 1),
        Question("${random1[4]} - ${random1[4]-2} =", 2),
        Question("${random2[4]} - ${random2[4]-3} =", 3),
        Question(" ", 1)
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_one_two_three_four, container, false)
