...
class PlusMinusHalfNumberFragment : Fragment() {

    private val random =  listOf(1,2,3,4,5).shuffled()
    private val random1 =  listOf(2,4,6,8,10).shuffled()


    val questions = listOf(
        Question("${random[0]} + ${random[0]} =", random[0]+random[0]),
        Question("${random1[0]} - ${random1[0]/2} =", random1[0]-(random1[0]/2)),
        Question("${random[1]} + ${random[1]} =", random[1]+random[1]),
        Question("${random1[1]} - ${random1[1]/2} =", random1[1]-(random1[1]/2)),
        Question("${random[2]} + ${random[2]} =", random[2]+random[2]),
        Question("${random1[2]} - ${random1[2]/2} =", random1[2]-(random1[2]/2)),
        Question("${random[3]} + ${random[3]} =", random[3]+random[3]),
        Question("${random1[3]} - ${random1[3]/2} =", random1[3]-(random1[3]/2)),
        Question("${random[4]} + ${random[4]} =", random[4]+random[4]),
        Question("${random1[4]} - ${random1[4]/2} =", random1[4]-(random1[4]/2)),
        Question(" ", 1)
    )
    ...
    override fun onCreateView(
       ...
       val view = inflater.inflate(R.layout.fragment_plus_minus_half_number, container, false)
