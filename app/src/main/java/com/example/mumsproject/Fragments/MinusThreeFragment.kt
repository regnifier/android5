...
class MinusThreeFragment : Fragment() {

   private val random =  listOf(3,4,5,6,7,8,9,10).shuffled()


    val questions = listOf(
        Question("${random[0]} - 3 =", random[0]-3),
        Question("${random[1]} - 3 =", random[1]-3),
        Question("${random[2]} - 3 =", random[2]-3),
        Question("${random[3]} - 3 =", random[3]-3),
        Question("${random[4]} - 3 =", random[4]-3),
        Question("${random[5]} - 3 =", random[5]-3),
        Question("${random[6]} - 3 =", random[6]-3),
        Question("${random[7]} - 3 =", random[7]-3),
        Question(" ", 1)
    )
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_minus_three, container, false)
